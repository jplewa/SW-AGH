...
void initialize_button_values()
{
    ...
    small_button_Y =
        big_button_Y + big_button_radius + small_button_radius + 20;
    big_button_distance = 20;
    medium_button_distance = 25;
    small_button_distance = 60;
    stop_button_X =
        LCD_X_SIZE / 2 - big_button_radius - big_button_distance / 2;
    play_button_X =
        LCD_X_SIZE / 2 + big_button_radius + big_button_distance / 2;
    ...
    minus_button_X =
        LCD_X_SIZE / 2 - small_button_radius - small_button_distance / 2;
    plus_button_X =
        LCD_X_SIZE / 2 + small_button_radius + small_button_distance / 2;
}
